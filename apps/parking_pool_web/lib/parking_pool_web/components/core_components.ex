defmodule ParkingPoolWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ParkingPoolWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ParkingPoolWeb.Gettext, "errors", msg, opts)
    end
  end
